...
- Per evaluation resource budgets and cooperative cancellation for nodes, functions, operators,
  lazy parameters, collection traversal and data accessor reads.
